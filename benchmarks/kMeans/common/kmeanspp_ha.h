#ifndef KMEANSPP_HAMERLY_ACC_H
#define KMEANSPP_HAMERLY_ACC_H
 ...
 * method to move those centers toward a local optimum (iterations).
 */
template <class F, class DST, class DSTSQ, class NRM, class NRMSQ, class INPD>
int kmeansppHamerlyAcc (F data[N][D], int num, int dim, int clusters, F error, 
...
#undef kmeans
#define kmeans(data, num, dim, clusters, error, irounds, kmbbrounds, lfactor, frac, rseed, distance, distancesqr, norm, normsqr, inprod, bfscr, score, steps) (kmeansppHamerlyAcc(data, num, dim, clusters, error, irounds, kmbbrounds, lfactor, frac, rseed, distance, distancesqr, norm, normsqr, inprod, bfscr, score, steps))
